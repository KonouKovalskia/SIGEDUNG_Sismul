...
async function init() {
  ...
  try {
    ...
    // BUG 5 FIX: inject into sidebar (has position:relative), not bldList
    injectErrorState(sidebar, "Tidak dapat memuat campus.json. Periksa koneksi Anda.", "./index.html");
    return;
  }
